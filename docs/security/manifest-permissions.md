...
| Browser baseline | `minimum_chrome_version: "148"` and structured-clone extension messaging | manifest, tab-capture output, and browser adapters | Lowering requires compatibility and owner proof. |
