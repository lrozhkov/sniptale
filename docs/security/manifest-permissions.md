...
| Browser baseline | Manifest-owned minimum Chrome version and structured-clone extension messaging | manifest, tab-capture output, and browser adapters | The current value is generated in [project facts](../engineering/project-facts.md); lowering requires compatibility and owner proof. |
