...
- Human and contributor guidance: `DESIGN.md`, `README.md`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`.
...
Dependencies, root build/test output, caches, editor state, local environment files, optional agent-tooling copies, derived agent-tooling ZIPs, and workspace tasks are ignored by `.gitignore`. The principal roots are `node_modules/**`, `dist/**`, `build/**`, `.tmp/**`, `.backup/**`, `.output/**`, `coverage/**`, `.playwright-browsers/**`, `playwright-report/**`, `test-results/**`, root `AGENTS.md`, root `.agents/**`, `artifacts/agent-tooling*.zip`, and root `/tasks/**`; tracked exceptions keep `tooling/build/**` and `apps/extension/build/**` in source. `tasks/**` must never be staged.
