...
import { FUNCTION_PROFILES } from './config.mjs';
import { collectEffectFamilies } from './owner-classifier.mjs';
import {
  createStructuralRiskReport,
  analyzeStructuralSource,
  validateStructuralAllowances,
} from './report.mjs';
import { isOrchestrationReviewExempt, scoreFile, scoreFunction } from './score.mjs';
import { sanitizeStructuralCliOutput } from './check.mjs';
