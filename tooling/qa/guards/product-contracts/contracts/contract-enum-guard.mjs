...
import { getNodeLine } from '../../../analysis/source/repo-scoped-typescript-scan.mjs';
import { fromRelativePath, toRelativePath } from '../../../analysis/repository/shared-paths.mjs';
...
export function collectContractEnumViolations(files = []) {
  ...
  for (const file of files) {
    ...
    const sourceFile = getSourceSnapshot({ filePath: fromRelativePath(relativePath) }).sourceFile;
    const visit = (node) => {
