...
import { PRODUCT_SOURCE_ROOTS } from '../../analysis/repository/src-production-targets.mjs';
...
const EXCLUDED_PATTERNS = [
  ...
  /^apps\/extension\/src\/design-system\/(?:parity|previews)\//u,
  /^apps\/extension\/src\/features\/scenario\/project\/v3\/templates\/bundled(?:\.summary)?\.data\.ts$/u,
  ...
  /^apps\/extension\/src\/scenario-editor\/project\/ai\/deck-payload\/slide-code\/examples\.ts$/u,
  /^apps\/extension\/src\/scenario-editor\/workspace\/visual-baseline\//u,
