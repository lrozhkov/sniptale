...
import { collectProductionImportEdges, createViolation } from './helpers.mjs';
import { repoRoot, toRelativePath } from '../../../analysis/repository/shared-paths.mjs';
import { collectStronglyConnectedComponents } from './scc-graph.mjs';

const SECOND_LEVEL_SCC_REGISTRY = JSON.parse(
  fs.readFileSync(new URL('./scc-registry.data.json', import.meta.url), 'utf8')
);
