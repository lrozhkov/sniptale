...
import { collectBrowserAdapterViolations } from '../../boundaries/browser/browser-adapters/check.mjs';
...
import { collectInventorySizeMetrics } from './size.mjs';
...
import { collectInventoryDiffSummary } from './diff.mjs';
