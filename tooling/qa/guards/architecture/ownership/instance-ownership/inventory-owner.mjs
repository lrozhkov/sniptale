...
const REVIEWED_CROSS_OWNER_PATH_REPLACEMENTS = [
  ...
  {
    from: 'apps/extension/src/scenario-editor/project/state/index.ts',
    to: 'apps/extension/src/scenario-editor/page-shell/runtime/use-state.ts',
    rule: 'no-top-level-mutable-runtime-state',
    waveId: 'scenario-editor-owner-seams',
  },
  {
    from: 'apps/extension/src/scenario-editor/project/state/values.ts',
    to: 'apps/extension/src/scenario-editor/page-shell/runtime/use-state.ts',
    rule: 'no-top-level-mutable-runtime-state',
    waveId: 'scenario-editor-owner-seams',
  },
  {
    from: 'apps/extension/src/scenario-editor/project/state/ui.ts',
    to: 'apps/extension/src/scenario-editor/page-shell/runtime/use-state.ts',
    rule: 'no-top-level-mutable-runtime-state',
    waveId: 'scenario-editor-owner-seams',
  },
