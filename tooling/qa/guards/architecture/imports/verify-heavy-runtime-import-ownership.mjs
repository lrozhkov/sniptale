...
const RULES = [
  {
    ...
    isViolation(relativePath) {
      return !relativePath.startsWith('apps/extension/src/editor/');
    },
  ...
  },
  {
    ...
    packageName: 'jszip',
    isViolation(relativePath) {
      return relativePath.startsWith('apps/extension/src/content/');
    },
    message:
  ...
  },
  {
    ...
    isViolation(relativePath) {
      return relativePath !== 'packages/platform/src/security/sanitizers/html.ts';
    },
