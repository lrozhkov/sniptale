export const OWNERSHIP_WAVES = [
  ...
  },
  {
    ...
    files: [
      ...
      'apps/extension/src/content/selection/highlighter-runtime/controller.actions.ts',
      'apps/extension/src/content/selection/highlighter-runtime/mode.ts',
      'apps/extension/src/content/selection/highlighter-runtime/runtime-listeners.ts',
      'apps/extension/src/content/selection/highlighter-runtime/state.ts',
