...
export const VIDEO_RECORDING_OWNER_MAPPINGS = [
  ...
  },
  {
    ...
    testFiles: [
      ...
      'apps/extension/src/offscreen/recording/start/recorder.failure.integration.test.ts',
      'apps/extension/src/offscreen/recording/start/recorder.lifecycle.test.ts',
      'apps/extension/src/offscreen/recording/start/recorder.sidecar.test.ts',
      'apps/extension/src/offscreen/recording/start/recorder.test.ts',
      'apps/extension/src/offscreen/recording/start/recorder.webcam.test.ts',
      'apps/extension/src/offscreen/runtime/index.start-error.test.ts',
    ],
  },
  {
