...
import { collectCodeFiles as codeFiles } from '../../../analysis/repository/shared-files.mjs';
import {
...
import { collectCoverageRolloutFiles } from './registry.mjs';
import { resolveCoverageThreshold } from './thresholds.mjs';
import { formatCoverageAdvice } from './feedback.mjs';
import { runLineLengthCheck as lineCheck } from '../../../guards/quality/readability/line-length/check.mjs';
import { runUnitTests as unit } from '../../unit/verify-unit-tests.mjs';
...
function collectCoverageNeutralLineRanges(relativePath, sourceText) {
  const sourceFile = getSourceSnapshot({ filePath: relativePath, text: sourceText }).sourceFile;
