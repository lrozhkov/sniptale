...
export const PAGE_ACCESS_OWNER_MAPPINGS = [
  {
    ...
    productionFile: 'apps/extension/src/background/page-access/lifecycle.ts',
    exclusive: true,
    reason: 'Page-access lifecycle cleanup is covered by the focused lifecycle suite.',
    testFiles: ['apps/extension/src/background/page-access/lifecycle.test.ts'],
  },
  {
    owner: 'background-page-access-route',
    productionFile: 'apps/extension/src/background/page-access/route.ts',
    exclusive: true,
    reason: 'PAGE_ACCESS route dispatch is covered by the focused route suite.',
    testFiles: ['apps/extension/src/background/page-access/route.test.ts'],
  },
  {
    owner: 'background-page-access-registration',
    productionFile: 'apps/extension/src/background/page-access/registration.ts',
    exclusive: true,
    reason: 'Dynamic content runtime registration is covered by site/all-sites grant suites.',
    testFiles: [
      'apps/extension/src/background/page-access/registration.test.ts',
      'apps/extension/src/background/page-access/service.all-sites-grants.test.ts',
      'apps/extension/src/background/page-access/service.site-grants.test.ts',
    ],
  },
  {
    owner: 'background-page-access-service',
    productionFile: 'apps/extension/src/background/page-access/service.ts',
    exclusive: true,
  ...
  },
  {
    ...
    productionFile: 'apps/extension/src/background/page-access/status.ts',
    exclusive: true,
    reason: 'Page-access status resolution is covered through route and service suites.',
    testFiles: [
      'apps/extension/src/background/page-access/route.test.ts',
      'apps/extension/src/background/page-access/service.test.ts',
    ],
  },
  {
    owner: 'background-page-access-tab-activation',
    productionFile: 'apps/extension/src/background/page-access/tab-activation.ts',
    exclusive: true,
    reason: 'Temporary tab activation storage is covered by service and lifecycle suites.',
    testFiles: [
      'apps/extension/src/background/page-access/lifecycle.test.ts',
      'apps/extension/src/background/page-access/tab-activation.test.ts',
    ],
  },
  {
    owner: 'background-page-access-target',
    productionFile: 'apps/extension/src/background/page-access/target.ts',
    exclusive: true,
    reason: 'Page-access target parsing is covered by the focused target suite.',
    testFiles: ['apps/extension/src/background/page-access/target.test.ts'],
  },
  {
