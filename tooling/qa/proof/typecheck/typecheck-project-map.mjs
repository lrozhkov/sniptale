...
export const TYPECHECK_PROJECT_MAP_PATH = 'tooling/qa/proof/typecheck/typecheck-project-map.mjs';
export {
  FULL_TYPECHECK_PROJECT_IDS,
  OWNER_TEST_TYPECHECK_PROJECTS,
  PRODUCTION_TYPECHECK_PROJECTS,
...
const FULL_TYPECHECK_TRIGGER_FILES = new Set([
  ...
  'tooling/qa/proof/typecheck/verify-typecheck-cache.mjs',
]);
...
export function requiresFullTypecheckControlProof(targetFiles = []) {
  return targetFiles.some((file) => FULL_TYPECHECK_TRIGGER_FILES.has(normalizePath(file)));
}
