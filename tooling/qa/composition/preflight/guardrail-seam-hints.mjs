...
import { isCodeFile, readText, splitLines } from '../../analysis/repository/shared-paths.mjs';
...
export function collectThinShellHints(codeFiles) {
  ...
  for (const file of codeFiles.filter(
    ...
    const sourceFile = getSourceSnapshot({ filePath: file, text: source }).sourceFile;
