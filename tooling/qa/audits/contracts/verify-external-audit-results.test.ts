...
import { runAstGrepCheck } from '../ast-grep/ast-grep.mjs';
import { runCodeqlCheck } from '../codeql/codeql.mjs';
import { runGitleaksCheck } from '../gitleaks/gitleaks.mjs';
import { runJscpdCheck } from '../jscpd/check.mjs';
import { runKnipCheck } from '../knip/knip.mjs';
import { runLicenseCheck } from '../licenses/licenses.mjs';
import { runAudit } from '../supply-chain/npm-audit.mjs';
import { runAuditSignatures } from '../supply-chain/npm-audit-signatures.mjs';
...
function createJscpdCase(root: string) {
  ...
  return createFileReportCase({
    id: 'jscpd',
    reportPath,
    validJson: '{"duplicates":[],"statistics":{"formats":{},"total":{"sources":0,"clones":0}}}',
