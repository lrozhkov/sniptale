import { writeFile } from '../../test-support/test-helpers';
    ...
    components: [
      {
        ...
        version: '4.2.0',
        purl: 'pkg:npm/eslint-plugin-sonarjs@4.2.0',
    ...
    components: [
      {
        ...
        purl: 'pkg:npm/eslint-plugin-sonarjs@4.2.0',
        licenses: [{ license: { id: 'LGPL-3.0-only' } }],
        properties: [{ name: 'cdx:npm:package:development', value: developmentProperty }],
      },
    ],
  });
}
