...
export async function seedFreshCheckpointState() {
  ...
  >('../../../runtime/scope/current-diff.helpers.mjs', import.meta.url);
  const checkpointHelpers = await importFresh<
    typeof import('../../../composition/checkpoint/verify-checkpoint.state.helpers.mjs')
  >('../../../composition/checkpoint/verify-checkpoint.state.helpers.mjs', import.meta.url);
