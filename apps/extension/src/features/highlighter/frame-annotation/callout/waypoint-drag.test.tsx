...
import type { PointerDragStartEvent } from '../interaction/pointer-drag-session';
...
function renderHarness(
  ...
  function Harness() {
    ...
    return <button data-waypoint-handle="true" onDoubleClick={drag.handleDoubleClick} />;
  }
...
it('supports keyboard movement, double-click reset, pointer rejection, and escape cancellation', () => {
  renderHarness('both');
  const keyboardEvent = {
    key: 'ArrowRight',
    shiftKey: true,
  ...
  act(() => drag?.handleKeyDown(keyboardEvent));
  expect(onChange).toHaveBeenCalled();
  act(() =>
    container
      ?.querySelector<HTMLButtonElement>('[data-waypoint-handle="true"]')
