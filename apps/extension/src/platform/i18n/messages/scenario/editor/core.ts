...
export const scenarioEditorCoreMessages = defineMessageSource({
  ...
  guideAiOffsetX: {
    ru: 'Смещение по горизонтали (доля рамки)',
    en: 'Horizontal offset (frame fraction)',
  },
  guideAiOffsetY: {
    ru: 'Смещение по вертикали (доля рамки)',
    en: 'Vertical offset (frame fraction)',
  },
  ...
  guidePageTemplates: { ru: 'Редактор страниц', en: 'Page editor' },
  guideScenarioTemplates: { ru: 'Редактор сценариев', en: 'Scenario editor' },
  guideAiStepParameters: { ru: 'Оформление шага', en: 'Step appearance' },
  guideAiBlockParameters: { ru: 'Параметры блока', en: 'Block parameters' },
  guideAiDisclosureText: {
    ru: 'Выбранному провайдеру и модели будут отправлены выбранный текст, параметры оформления, подписи, сохранённый контекст действий выбранных изображений и ваш запрос. Применяется системная инструкция из настроек. Журнал запросов хранит служебные сведения без текста и изображений.',
    en: 'The selected provider and model will receive the selected text, appearance parameters, captions, saved action context of selected images and your request. The system instruction from settings also applies. Request history stores metadata without text or images.',
  },
  guideAiDisclosureImages: {
    ru: 'Выбранному провайдеру и модели будут отправлены выбранный текст, параметры оформления, подписи, сохранённый контекст действий, видимые кадры изображений и ваш запрос. Применяется системная инструкция из настроек. Журнал запросов хранит служебные сведения без текста и изображений.',
    en: 'The selected provider and model will receive the selected text, appearance parameters, captions, saved action context, visible image frames and your request. The system instruction from settings also applies. Request history stores metadata without text or images.',
  },
  ...
  guideNavigationTop: { ru: 'Сверху', en: 'At the top' },
  guideNavigationSide: { ru: 'Слева', en: 'On the left' },
