...
describe('frame-manager-session-effects', () => {
  it('routes session effects through the explicit syncFocusOpacity seam', async () => {
    ...
    expect(mocks.useFrameSessionSync).toHaveBeenCalledWith({
      ...
      sessionBlurSettingsRef: currentArgs.refs.sessionSettingsRefs.blurSettings,
      sessionCalloutStyleRef: currentArgs.refs.sessionCalloutStyleRef,
      sessionDefaultsInitializedRef: currentArgs.refs.sessionSettingsRefs.defaultsInitialized,
      sessionFocusSettingsRef: currentArgs.refs.sessionSettingsRefs.focusSettings,
