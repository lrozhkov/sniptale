...
export const InteractiveFrame: React.FC<InteractiveFrameProps> = React.memo((props) => {
  ...
  const contentProps = {
    ...
    activeCalloutIndex: model.viewState.activeCalloutIndex,
    setTempFrame: model.viewState.setTempFrame,
    stageCalloutFrame: model.viewState.stageCalloutFrame,
    ...
    setActiveCalloutIndex: model.viewState.setActiveCalloutIndex,
