...
import * as targetResolutionFacade from '.';
...
describe('ai-pick target resolution', () => {
  it('keeps legacy lookup helpers behind owner-local modules', () => {
    expect(Object.keys(targetResolutionFacade).sort()).toEqual([
      'findAIChangeTargets',
      'findFieldElementById',
      'findTableRowElementById',
    ]);
  });
