...
export const AIModalDataPanel: React.FC<AIModalDataPanelProps> = ({
  ...
  return (
    <AIModalDataPanelContent
      ...
      filteredTreeData={state.filteredTreeData ?? treeData}
      ...
      toggleSelectFiltered={state.toggleSelectFiltered}
      treeData={treeData}
      treeRenderProps={{
