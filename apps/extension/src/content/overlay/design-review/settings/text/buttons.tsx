...
function resetTextModeValues(actions: DesignReviewActions) {
...
export function TextModeButtons(props: {
  ...
  return (
    <IconButtonRow
      disabled={props.disabled}
      label={translate('content.designReview.textStyleGroup')}
...
function useTextModeButtonModel(state: DesignReviewViewState) {
...
function FontWeightButton(props: {
  ...
  return (
    <ToggleButton
      ...
      disabled={props.disabled}
      label={translate('content.designReview.fontWeight')}
      onClick={() =>
...
function FontStyleToggle(props: {
  ...
  return (
    <ToggleButton
      ...
      disabled={props.disabled}
      label={translate('content.designReview.fontStyle')}
      onClick={() =>
        props.actions.updateValue(
          'font-style',
  ...
  return (
    <>
      <DecorationButton
        ...
        disabled={props.disabled}
        label={translate('content.designReview.optionUnderline')}
        line="underline"
      ...
      <DecorationButton
        decoration={props.decoration}
        disabled={props.disabled}
        label={translate('content.designReview.optionLineThrough')}
        line="line-through"
        onToggle={(nextValue) => props.actions.updateValue('text-decoration', nextValue)}
      >
  ...
  return [
    {
      ...
      label: translate('content.designReview.optionLeft'),
      value: 'left',
    },
    {
      icon: <AlignCenter size={15} />,
      label: translate('content.designReview.optionCenter'),
      value: 'center',
    },
    {
      icon: <AlignRight size={15} />,
      label: translate('content.designReview.optionRight'),
      value: 'right',
    },
    {
      icon: <AlignJustify size={15} />,
      label: translate('content.designReview.optionJustify'),
      value: 'justify',
    },
  ] as const;
}
...
export function TextAlignButtons(props: {
  ...
  return (
    <IconButtonRow
      disabled={props.disabled}
      label={translate('content.designReview.textAlign')}
      modified={modified}
