...
export function DesignReviewActionMenu(props: {
  ...
  return (
    <div ref={containerRef} className="relative min-w-0 cursor-default">
      <button
        ref={triggerRef}
        type="button"
        aria-expanded={open}
      ...
      >
        <SelectedIcon className={getDesignReviewActionTone(props.action)} size={16} />
        ...
        >
          {DESIGN_REVIEW_ACTIONS.map((option) => {
            ...
            return (
              ...
              >
                <Icon className={getDesignReviewActionTone(option.action)} size={16} />
