...
function createSectionModalsMock() {
  return {
...
vi.mock('./modals', createSectionModalsMock);
...
it('renders modal branches and confirm dialog actions through the state-owned handlers', async () => {
