...
it('renders the empty presets state and header metadata', () => {
  renderList();

  expect(container?.textContent).toContain(translate('viewportPresets.section.savedLabel'));
