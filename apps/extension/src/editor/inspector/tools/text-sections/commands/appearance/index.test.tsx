...
import { buildTextAppearanceCommands } from './';
import { createTextCommandParams, getTextAppearanceCommandControl } from './test-support';

function registerAppearanceCommandShapeTests() {
...
function registerAppearanceCommandInteractionTests() {
...
describe('buildTextAppearanceCommands', () => {
  registerAppearanceCommandShapeTests();
  registerAppearanceCommandInteractionTests();
});
