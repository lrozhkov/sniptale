...
import { handleScenarioSessionQuery, handleScenarioSetEnabled } from '../session-actions';
...
it('re-exports the session-action handlers through the root facade', async () => {
