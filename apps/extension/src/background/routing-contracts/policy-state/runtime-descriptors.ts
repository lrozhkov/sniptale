...
export const runtimePolicyStateDescriptors = [
  {
    ...
    proofModules: ['apps/extension/src/background/capture/page-package/job/index.test.ts'],
    requiresTtl: false,
    restartBehavior:
  ...
  },
  {
    ...
    oneShot: false,
    ownerModule: 'apps/extension/src/background/capture/page-package/job/lifecycle-gate.ts',
    proofModules: [
  ...
  {
    authorityFamily: 'page-package-download',
    failClosedOnRestart: true,
    id: 'page-package-download-leases',
    oneShot: false,
    ownerModule: 'apps/extension/src/offscreen/page-package-download/lease.ts',
    proofModules: ['apps/extension/src/offscreen/page-package-download/lease.test.ts'],
    requiresTtl: true,
    restartBehavior: [
      'Offscreen document teardown revokes its document-owned object URLs and discards every lease;',
      'Background reconciliation retries the interrupted download from the durable staged asset.',
    ].join(' '),
