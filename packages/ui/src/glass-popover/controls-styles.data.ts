export const glassPopoverControlsStyles = `
.sniptale-glass-icon-button,
.sniptale-glass-chip,
.sniptale-glass-color-trigger,
.sniptale-glass-mini-button,
.sniptale-glass-bold-button {
  border: 1px solid color-mix(in srgb, var(--sniptale-color-border-soft) 72%, transparent);
  border-top-color: color-mix(in srgb, var(--sniptale-color-text-inverse) 7%, transparent);
...
.sniptale-glass-icon-button:hover,
.sniptale-glass-chip:hover,
.sniptale-glass-color-trigger:hover,
.sniptale-glass-mini-button:hover,
.sniptale-glass-bold-button:hover {
  background: color-mix(
    in srgb,
...
.sniptale-glass-icon-button:active,
.sniptale-glass-chip:active,
...
.sniptale-glass-chip-icon {
  display: inline-flex;
  align-items: center;
  justify-content: center;
}
.sniptale-glass-option-grid {
  display: grid;
...
.sniptale-glass-preset-item {
  ...
  padding: 10px 11px;
  border-radius: 10px;
  border: 1px solid color-mix(in srgb, var(--sniptale-color-border-soft) 78%, transparent);
  background: color-mix(
    in srgb,
    var(--sniptale-color-surface-canvas) 14%,
    var(--sniptale-color-surface-panel) 86%
  );
  color: var(--sniptale-color-text-secondary);
  cursor: pointer;
  box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--sniptale-color-border-subtle) 40%, transparent);
}
.sniptale-glass-preset-item:hover {
  background: color-mix(in srgb, var(--sniptale-color-border-subtle) 72%, transparent);
  border-color: color-mix(in srgb, var(--sniptale-color-border-strong) 72%, transparent);
...
.sniptale-glass-preset-meta {
  min-width: 0;
  flex: 1;
}
.sniptale-glass-preset-name {
  display: block;
  font-size: 12px;
  white-space: nowrap;
  overflow: hidden;
